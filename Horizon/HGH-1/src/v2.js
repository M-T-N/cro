...
function init() {
  ...
  qs('#Mainstage .info').innerHTML = `
    <span class="time-left-title">
      Highest Rated, Experienced, & Trained Technicians
    </span>
    <p>
      Horizon Technicians and Plumbers are required to complete 150 hours of hands-on, technical training every year. No matter how complex your issue, our technicians are fully equipped to tackle the job and get it done right the first time. Our reputation and industry-leading warranties speak for themselves!
    </p>
