...
function init() {
  ...
  jQuery('a.btn[href="https://www.fenwickhomeservices.com/indoor-air-quality/"]').closest('section').insertBefore('.star-reviews');
  ...
  qs('.module--content-module a[href="https://www.fenwickhomeservices.com/heating/heater-tune-up/"]').addEventListener('click', function(){
    ga('send', 'event', 'cro conversion', 'HGH12_V0: Heater Tune-up click');
  });
