...
function init() {
  ...
  // Put the new Heater Tune-Up Module, above the coupon banner
  qs('a.btn[href="https://www.fenwickhomeservices.com/coupons/"]').closest('section').insertAdjacentHTML('beforebegin', newSection);

  // gtm push
  qs('.module--content-module a[href="https://www.fenwickhomeservices.com/heating/heater-tune-up/"]').addEventListener('click', function(){
    ga('send', 'event', 'cro conversion', 'HGH12_V1: Heater Tune-up click');
  });
