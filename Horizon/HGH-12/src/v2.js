...
function init() {
  ...
  <div class="info">
    ...
    <div class="info__contact">
      ...
      <span class="info__contact__book">
        <a href="/book-online/" class="btn btn-ezbook">
  ...
  var newSection = `
    <section class="module--content-module magic show hzn-pt-16 hzn-pb-2" style="background-color: rgb(245, 244, 243);">
      <div class="main temp-module temp-left items-start flex-col">
        ...
        <div class="tm-content" style="width: 70%; color: rgb(30, 30, 30); font-size: 20px;">
          ...
          <p>In a perfect world, you could rely on your system to function properly all year long. Unfortunately, systems tend to break when you need them the most. With just an hour or two of preventive maintenance each fall, your furnace can last longer, while costing less to run.</p>
          <p>We are currently offering a Heater Tune-up with Free 1" Filter for $59 until 11/30/22. Click "Learn More" to learn what a tune-up includes and schedule your appointment online today.</p>
          <a href="https://www.fenwickhomeservices.com/heating/heater-tune-up/" class="btn tm-cta-7 self-start hzn-mt-16 hzn-mb-16">Learn More</a>
        </div>
      </div>
    </section>
  `;
      
  // Move the Indoor Air Quality section to the bottom above reviews module
  jQuery('a.btn[href="https://www.fenwickhomeservices.com/indoor-air-quality/"]').closest('section').insertAfter(jQuery('a.btn[href="https://www.fenwickhomeservices.com/plumbing-services/drain-clearing/"]').closest('section'));

  // Move the Air Conditioning Repair module above the Plumbing Repair module
  jQuery('a.btn[href="https://www.fenwickhomeservices.com/air-conditioning-service/ac-repair/"]').closest('section').insertBefore(jQuery('a.btn[href="https://www.fenwickhomeservices.com/plumbing-services/plumbing-repair/"]').closest('section'));

  // Put the new Heater Tune-Up Module, where the AC one just was (right above the Heating & Furnace Repair module)
  qs('a.btn[href="https://www.fenwickhomeservices.com/heating/heater-repair/furnace-repair/"]').closest('section').insertAdjacentHTML('beforebegin', newSection);

  // put review above coupon banner
  jQuery('.star-reviews').insertBefore(jQuery('a.btn[href="https://www.fenwickhomeservices.com/coupons/"]').closest('section'));



  // gtm push
  qs('.module--content-module a[href="https://www.fenwickhomeservices.com/heating/heater-tune-up/"]').addEventListener('click', function(){
    ga('send', 'event', 'cro conversion', 'HGH12_V2: Heater Tune-up click');
  });
