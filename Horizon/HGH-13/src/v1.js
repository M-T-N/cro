...
function init() {
  ...
  jQuery('a.btn[href="https://www.snellheatingandair.com/indoor-air-quality/"]').closest("section").insertAfter('.star-reviews');
  
  
  //insert new section
  qs('a[href="https://www.snellheatingandair.com/same-day/"]').closest('section').insertAdjacentHTML('beforebegin', newSection)
  ...
  qs('.module--content-module a[https://www.snellheatingandair.com/heating-services/furnace-tune-up/"]').addEventListener('click', function(){
    ga('send', 'event', 'cro conversion', 'HGH13_V1: Heater Tune-up click');
  });


  ga("create", {
    trackingId: "UA-2087246-20",
    cookieDomain: "auto",
    name: "HGH13",
  });
