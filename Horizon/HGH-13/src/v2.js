...
function init() {
  ...
  jQuery(".star-reviews").insertBefore(jQuery('a[href="https://www.snellheatingandair.com/same-day/"]').closest("section"));
  ...
  qs('.module--content-module a[https://www.snellheatingandair.com/heating-services/furnace-tune-up/"]').addEventListener('click', function(){
    ga('send', 'event', 'cro conversion', 'HGH13_V2: Heater Tune-up click');
  });
