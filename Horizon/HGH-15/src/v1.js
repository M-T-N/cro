...
function init() {
  ...
  function loadPopup(){
    ...
    qs('.tin__ezbook-popup__content-cta--button a').addEventListener('click', function(){
      ga('send', 'event', 'cro conversion', 'HGH15_V1: Popup Modal CTA click');
    });
  }

  // CTA click in nav/hamburger menu
  qs('.mega-ezbook a').addEventListener('click', function(){
    ga('send', 'event', 'cro conversion', 'HGH15_V1: NavBar/HamburgerMenu CTA click');
  });
  ...
  setTimeout(function(){
    ...
    document.cookie = 'hgh15=true; expires=' + now.toUTCString() + '; path=/;';
