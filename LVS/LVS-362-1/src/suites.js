...
import { textUpdateSuites } from './utils/textUpdateSuites';
import { towerIcons } from './utils/towerIconsSuites';
import { roomFilter } from './utils/roomFilterSuites';
import { suitesNewRooms } from './utils/suitesNewRooms';
...
function init() {
  ...
  // remove bottom 2 room type containers
  qsa('.mod-suites-browse-listing:last-of-type').forEach(function(el){
    el.remove();
  });
