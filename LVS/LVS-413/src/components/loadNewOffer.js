    ...
    <a href="/offers/the-big-game-2024-offer.html">
      <figure class="o-offer__media scaled">
          <picture class="content img-normal-size">
            ...
            <img class=" lazyloaded" data-src="${imageURL}.resize.0.0.614.408.jpg" alt="${offerTitle}" src="${imageURL}.resize.0.0.614.408.jpg">
          </picture>
          <picture class="content img-large-size">
            ...
            <img class="lazyload" data-src="${imageURL}.resize.0.0.614.408.jpg" alt="${offerTitle}">
          </picture>
          <h3>
            <span>The</span>
