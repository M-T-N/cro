...
export function featuredTemplatePreload(image, offerLink) {
	...
	const featuredHTML = `
		<div class="mod-offers-listing__featured--wrap">
			...
			<div class="js-details-content o-offer__text">
				<h3 class="o-offer__tagline"><a href="/offers/best-offer.html">...</a></h3>
				<span class="o-offer__divider"></span>
				<div class="o-offer__text__details">
						<div class="o-offer__text__details__item"><span class="bold">Stay Dates:</span> ...</div>
						<div class="o-offer__text__details__item">...</div>
						<div class="o-offer__text__details__item"><span class="bold">Offer Details:</span> ...</div>
				</div>
				<ul class="mod-offers-listing__buttons">
						<li>
							<a class="cta cta--arrow" href="https://www.venetianlasvegas.com/booking?start_month=current">
