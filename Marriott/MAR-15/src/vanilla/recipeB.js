  ...
  function mar15() {
    ...
    function openOverlay(){
      qs('.tin--best-rate__tab').addEventListener('click', () => {
        ...
        qs('.tin-modal .mfp-content').focus();


        // keep focus within modal when tabbing for ADA compliance
        function trapFocus(element) {
          var focusableEls = element.querySelectorAll('.modal-content, a, .mfp-close');
        ...
        trapFocus(qs('.tin-modal .mfp-content'));
